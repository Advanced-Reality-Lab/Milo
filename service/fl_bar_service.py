## /////////////////
## This is the main file for the chat mode
##
##///////////////////

from flask import jsonify, send_from_directory, Flask, abort, request

from utils.bar_service import main, set_stop
...
if __name__ == "__main__":
    ...
    parser.add_argument("--return_port", help="the port to return the data")
